...
public class MultipleWindowNaukri_com {
	...
	List<WebElement> pfls=	pfd.findElements(By.tagName("a"));
		...
		int pfhy=pfls.size();
		System.out.println("footer hyperlink="+pfhy);
		
		for(int i=0; i<pfhy; i++)
		{
		...
		ArrayList<String> al=new ArrayList<String>(key);
		String singlekey=al.get(0);
